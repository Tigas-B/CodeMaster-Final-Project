    ...
    ?>
    <footer>
        <div class="row mx-0 mt-5 pt-0 pt-lg-5">
            <div class="col px-0">
                <iframe class="mapa w-100"  height="513" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24034.031766973774!2d-8.63619639928643!3d41.15080922977087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd2465d04e5277a1%3A0x1a25f000e38c94e5!2sCooperativa%20Tripeira%2C%20Contumil%2C%20Porto!5e0!3m2!1spt-PT!2spt!4v1730742835095!5m2!1spt-PT!2spt" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
        <div class="row mx-0 mx-0 text-center facebook">
            <div class="col pt-md-4 px-0 escuro">
                <img class="mt-5" src="public/imagens/facebook.svg" alt="">
                <a class="text-decoration-none text-white" target="_blank" href="<?= $contactos["facebook"]; ?>"><p class="mt-md-5 pt-md-2 pt-4 pb-2 mb-5">Siga-nos no Facebook</p></a>
                <hr>
                <div class="row mx-0 mx-0 d-none d-xl-flex">
                ...
                <div class="row mx-0 mx-0 d-none d-lg-flex d-xl-none">
                ...
                <div class="row mx-0 mx-0 offset-lg-1 px-4">
