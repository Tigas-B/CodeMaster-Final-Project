    <?php
        if(!empty($_GET["editar"])){
            $id = $_GET["editar"];
            $empreendimento_unico = empreendimentoEspecificoID($id);
            if(!empty($_GET["titulo"]) && !empty($_GET["imagem"]) && !empty($_GET["texto"])){
                ...
                iduSQL("UPDATE empreendimentos SET titulo='$titulo', imagem='$imagem', texto='$texto', editor='$editor', data_de_edicao='$data_de_edicao' WHERE id='$id'");
    ...
    <main class="container text-center">
        <?php if(empty($empreendimento_unico)): ?>
            <div class="row">
                <div class="col my-5">
                    <h2>Não Existe Nenhum Empreendimento Com Esse Nome!</h2>
                </div>
            </div>
        <?php else: ?>
            <div class="row">
            ...
            <form class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" name="titulo" size="60" value="<?= $empreendimento_unico["titulo"]; ?>" required>   
                    <br><br>
                    <label for="imagem" class="pe-2 fs-4">Imagem:</label>
                    <input type="text" name="imagem" size="90" value="<?= $empreendimento_unico["imagem"]; ?>" required>   
                ...
                <div class="col-12 mt-4">
                    <textarea id="texto" name="texto" cols="160" rows="35" required><?= $empreendimento_unico["texto"]; ?></textarea>
                    <script>
