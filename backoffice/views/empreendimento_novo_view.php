    <?php
        if(!empty($_GET["titulo"]) && !empty($_GET["imagem"]) && !empty($_GET["texto"])){
            ...
            iduSQL("INSERT INTO empreendimentos (titulo, imagem, texto, editor, data_de_edicao) VALUES ('$titulo', '$imagem', '$texto', '$editor', '$data_de_edicao')");
