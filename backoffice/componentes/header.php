                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "carousels") ? "active" : "" ?>" href="carousels.php">Carousel</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "banners") ? "active" : "" ?>" href="banners.php">Banners</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "menu_simples") ? "active" : "" ?>" href="menu_simples.php">Menu Simples</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "noticias") ? "active" : "" ?>" href="noticias.php">Noticias</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "destaques") ? "active" : "" ?>" href="destaques.php">Destaques</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($menu == "empreendimentos") ? "active" : "" ?>" href="empreendimentos.php">Empreendimentos</a>
                                </li>
                                <li class="nav-item">
